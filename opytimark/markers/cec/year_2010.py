...
class F4(CECBenchmark):
    r"""F4 class implements the Single-group Shifted and m-rotated Elliptic's benchmarking function.
...
class F5(CECBenchmark):
    r"""F5 class implements the Single-group Shifted and m-rotated Rastrigin's benchmarking function.
...
class F6(CECBenchmark):
    r"""F6 class implements the Single-group Shifted and m-rotated Ackley's benchmarking function.
...
class F7(CECBenchmark):
    r"""F7 class implements the Single-group Shifted and m-rotated Schwefel's Problem 1.2 benchmarking function.
...
class F8(CECBenchmark):
    r"""F8 class implements the Single-group Shifted and m-rotated Rosenbrock's benchmarking function.
...
class F9(CECBenchmark):
    r"""F9 class implements the D/2m-group Shifted and m-rotated Elliptic's benchmarking function.
...
class F10(CECBenchmark):
    r"""F10 class implements the D/2m-group Shifted and m-rotated Rastrigin's benchmarking function.
...
class F11(CECBenchmark):
    r"""F11 class implements the D/2m-group Shifted and m-rotated Ackley's benchmarking function.
...
class F12(CECBenchmark):
    r"""F12 class implements the D/2m-group Shifted and m-rotated Schwefel's Problem 1.2 benchmarking function.
...
class F13(CECBenchmark):
    r"""F13 class implements the D/2m-group Shifted and m-rotated Rosenbrock benchmarking function.
...
class F14(CECBenchmark):
    r"""F14 class implements the D/m-group Shifted and m-rotated Elliptic's benchmarking function.
...
class F15(CECBenchmark):
    r"""F15 class implements the D/m-group Shifted and m-rotated Rastrigin's benchmarking function.
...
class F16(CECBenchmark):
    r"""F16 class implements the D/m-group Shifted and m-rotated Ackley's benchmarking function.
...
class F17(CECBenchmark):
    r"""F17 class implements the D/m-group Shifted Schwefel's Problem 1.2 benchmarking function.
...
class F18(CECBenchmark):
    r"""F18 class implements the D/m-group Shifted Rosenbrock's benchmarking function.
...
class F19(CECBenchmark):
    r"""F19 class implements the Shifted Schwefel's Problem 1.2 benchmarking function.
...
class F20(CECBenchmark):
    r"""F20 class implements the Shifted Rosenbrock's benchmarking function.
